    ...
    return (
        ...
        <div className='relative'>
            ...
            <div className='absolute inset-0 flex items-center justify-start ml-5 '>
                <p className='mt-56 xl:text-xl font-semibold text-white xl:mt-36 lg:mt-44 lg:text-lg md:text-base md:mt-32 sm:mt-16 sm:text-sm'>{modelo}</p>
            </div>

            <div className='absolute inset-0 flex items-center justify-end mt-56 mr-5 xl:mt-36 lg:mt-44 md:mt-32 sm:mt-16'>
