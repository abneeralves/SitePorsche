    ...
    return (
        ...
        <div className='relative'>
            ...
            <div className='absolute inset-0 flex items-center justify-end mt-56 mr-5 '>
                <a href={link} className='hover:bg-zinc-500 hover:opacity-70 transition duration-300 rounded p-1'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 ">
